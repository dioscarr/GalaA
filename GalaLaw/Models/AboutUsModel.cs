...
namespace GalaLaw.Models
{
    public class AboutUsModel
    {
        ...
        public AboutUsModel()
        {
          ...
          executives = db.Team.Where(c => c.Type == "Executive").Select(c=> new Executives { id = c.Id, Name = c.FName + " " + c.LName, picture = c.Picture, title = c.Title, Order = (int)c.order , country = c.CMFRelation.FirstOrDefault().Country.CountryName, FID = c.CMFRelation.FirstOrDefault().Firm.Id }).OrderBy(i => i.FID).ToList();
        }
