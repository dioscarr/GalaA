    ...
    public class RegisterUsers
    {
        ...
        public static string DeleteRole(string RoleName)
        {
            ...
            var RoleManager1 = new RoleManager<IdentityRole>(new RoleStore<IdentityRole>(context));
             ...
             IdentityRole IR =  RoleManager1.FindByName("RoleName");
            var ObjRole = context.Roles.Where(c => c.Name.Equals(RoleName, StringComparison.CurrentCultureIgnoreCase)).FirstOrDefault();

            context.Roles.Remove(ObjRole);
        ...
        /// <returns></returns>
        public static string UserToRole(string RoleName, string UserID)
        {
            ApplicationDbContext context = new ApplicationDbContext();
            var result = "";
            var RoleManager1 = new RoleManager<IdentityRole>(new RoleStore<IdentityRole>(context));
            ...
            if (RoleManager1.RoleExists(RoleName))
            {
               ...
               var r = UserManager.AddToRole(UserID, RoleName);
                result = "Successful";
            }
